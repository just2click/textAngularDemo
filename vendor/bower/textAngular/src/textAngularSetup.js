...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', function(taRegisterTool, $window, taTranslations, taSelection, taToolFunctions){
	...
	taRegisterTool('insertBoardLink', {
		tooltiptext: taTranslations.inserBoardtLink.tooltip,
		iconclass: 'fa fa-link',
		action: function(){
			var description;
			description = $window.prompt(taTranslations.inserBoardtLink.dialogPrompt, '');
			if(description && description !== ''){
				var embed = '{!boardLink:' + description + '}';
				// insert
				return this.$editor().wrapSelection('insertHTML', embed, true);
			}
		},
